...
function seqConfig() {
  ...
  return {
    ...
    coolEnabled:               document.getElementById("seq-cool-enable")?.checked ?? true,
    coolTemp:                  Number(document.getElementById("seq-cool-temp")?.value ?? -5),
    coolWaitMin:               Number(document.getElementById("seq-cool-wait")?.value) || 20,
